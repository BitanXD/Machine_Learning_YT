...
TBDB_IMG_500 = "https://image.tmdb.org/t/p/w500"
...
# path configs and global vars declared
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DF_PATH = os.path.join(BASE_DIR, "movie_df.pkl")
...
async def tmdb_get(path: str, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if r.status_code!=200:
        raise HTTPException(
            status_code=502,
            detail=f'TMBD error {r.status_code}: {r.text}'
        )
